...
namespace ImgUpload
{
    ...
    /// for demonstration purposes. Please see http://salient.codeplex.com for full implementation.
    /// </summary>
    ...
    public static class UploadHelper
    {
            ...
            if (headers != null)
            {
                ...
                foreach (string key in headers.AllKeys)
                {
                    ...
                    if (values != null)
                        ...
                        {
                            if (key.ToLower() == "user-agent") { webrequest.UserAgent = value; }
                            else if (key.ToLower() == "host") { webrequest.Host = value; }
                            else if (key.ToLower() == "connection") { webrequest.KeepAlive = (value.ToLower() == "keep-alive"); }
                            else if (key.ToLower() == "accept") { webrequest.Accept = value; }
                            else if (key.ToLower() == "referer") { webrequest.Referer = value; }
                            else webrequest.Headers.Add(key, value);
                        }
                }
            }
        ...
        /// <summary>
        /// Allow to retrieve text / webpage source at the given URL (Method added by ORelio)
        /// </summary>
        /// <param name="url">URL of the page</param>
        /// <returns>Returns the content of the page (no error catching !)</returns>

        public static string GetTextAt(string url)
        {
